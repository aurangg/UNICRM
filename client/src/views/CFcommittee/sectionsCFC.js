            ...
            <GridItem xs={12} sm={12} md={6}  lg={6}>
              <Card>
                ...
                <GridItem xs={12} sm={6} md={6} lg={6}>
                    <CardBody>
                        <Button href="/committee/details" color="primary" round style={buttonStyle}>Section S</Button> 
                    </CardBody>
                </GridItem>
                <GridItem xs={12} sm={6} md={6} lg={6}>
                    <CardBody>
                        <Button href="/committee/details" color="primary" round style={buttonStyle}>Section T</Button> 
                    </CardBody>
                </GridItem>
                </GridContainer>
              </Card>
