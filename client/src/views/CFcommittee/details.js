            ...
            <GridItem xs={12} sm={12} md={12}  lg={12}>
              <Card>
                ...
                <GridItem xs={12} sm={4} md={4} lg={4}>
                    <CardBody>
                        <Button href="/committee/sections" color="primary" round style={buttonStyle}> Web Engineering <br/>
                ...
                <GridItem xs={12} sm={4} md={4} lg={4}>
                    <CardBody>
                        <Button href="/committee/sections" color="primary" round style={buttonStyle}> Advance SE</Button> 
                    </CardBody>
                </GridItem>
                <GridItem xs={12} sm={4} md={4} lg={4}>
                    <CardBody>
                        <Button href="/committee/sections" color="primary" round style={buttonStyle}> IOT</Button> 
                    </CardBody>
                </GridItem>
                <GridItem xs={12} sm={4} md={4} lg={4}>
                    <CardBody>
                        <Button href="/committee/sections" color="primary" round style={buttonStyle}> Android</Button> 
                    </CardBody>
                </GridItem>
                </GridContainer>
              </Card>   
