...
export default function Aaddsection(props) {
  ...
  useEffect(() => {
    ...
    function getTeachers() {
      axios.get(`/admin/addsectiongetall`)
...
//   const [labdisplay, setLabdisplay] = React.useState(false);
//   const [inputList, setInputList] = React.useState([{ uniq: uuidv4(), activecourse:"", name: "", lecteacher: "", labteacher: "",labstatus:"lecture" }]);
//   const [labList, setLabList] = React.useState([{ uniq: uuidv4(), activecourse:"", name: "", lecteacher: "", labteacher: "",labstatus:"lab" }]);
...
//     setInputList(listlab);

//   };
// // handle click event of the Add button
//   const handleAddClick = () => {
//     setInputList([...inputList, { uniq: uuidv4(), activecourse:"", name: "", lecteacher: "", labteacher: "",labstatus:"lecture" }]);
//     setLabList([...labList, { uniq: uuidv4(), activecourse:"", name: "", lecteacher: "", labteacher: "",labstatus:"lab" }]);
//   };
//   const handleInputChange = (e, index) => {
//     const list = [...inputList];
//     const { name, value } = e.target;
