...
const ANavcoursedataTable = {
  headerRow: ["CourseCode", "Course Name", "Mentor", "Sections" , "Teachers","Actions"],
  footerRow: ["CourseCode", "Course Name", "Mentor", "Sections" , "Teachers","Actions"],
  dataRows: [
    ["Tiger Nixon", "System Architect", "Edinburgh", "61"],
    ["Garrett Winters", "Accountant", "Tokyo", "63"],
    ["Ashton Cox", "Junior Technical Author", "San Francisco", "66"],
